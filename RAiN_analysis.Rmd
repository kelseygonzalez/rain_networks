...
* Cahnge histograms to percent  
* Fix issue with code for act_instancesEmo: For two respondents return is -Inf  
...
# Mother's education: Bar plot

parentEduc_descrPlot <- clean_data %>%
...
# Generate data
nActivation_descriptives <- clean_data %>%
  drop_na(alter_data) %>%
...
Here's the plots with all respondents nTiesAct == 27 filtered out.

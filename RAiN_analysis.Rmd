...
nTiesAct_descriptives <- clean_data_completeAlterdata %>%
...
nTiesTotal_descriptives <- clean_data_completeAlterdata %>%
    drop_na(important_people) %>%
...
# Generate data
nActivation_descriptives <- clean_data_completeAlterdata %>%
